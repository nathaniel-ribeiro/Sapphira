...
class AccuracyCalculatorTest {
    ...
    fun setup(){
        ...
        // 3. c3c4
        every { reviewedMove2R.movePlayed } returns Move("c3", "c4", RED)
        ...
        // 3. ... a9b9
        every { reviewedMove2R.movePlayed } returns Move("a9", "b9", BLACK)
        ...
        // 4. h0g2
        every { reviewedMove2R.movePlayed } returns Move("h0", "g2", RED)
        ...
        // 4. ... g6g5
        every { reviewedMove2R.movePlayed } returns Move("g6", "g5", BLACK)
        ...
        // 5. h2h6
        every { reviewedMove2R.movePlayed } returns Move("h2", "h6", RED)
        ...
        // 5. ... h9g7
        every { reviewedMove2R.movePlayed } returns Move("h9", "g7", BLACK)
        ...
        // 6. a0a1
        every { reviewedMove2R.movePlayed } returns Move("a0", "a1", RED)
        ...
        // 6. ... h7i7
        every { reviewedMove2R.movePlayed } returns Move("h7", "i7", BLACK)
        ...
        // 7. i0h0
        every { reviewedMove2R.movePlayed } returns Move("i0", "h0", RED)
        ...
        // 7. ... i9h9
        every { reviewedMove2R.movePlayed } returns Move("i9", "h9", BLACK)
        ...
        // 8. a1f1
        every { reviewedMove2R.movePlayed } returns Move("a1", "f1", RED)
        ...
        // 8. ... b9b3
        every { reviewedMove2R.movePlayed } returns Move("b9", "b3", BLACK)
        ...
        // 9. h6g6
        every { reviewedMove2R.movePlayed } returns Move("h6", "g6", RED)
        ...
        // 9. ... g7e8
        every { reviewedMove2R.movePlayed } returns Move("g7", "e8", BLACK)
        ...
        // 10. e2e6
        every { reviewedMove2R.movePlayed } returns Move("e2", "e6", RED)
        ...
        // 10. ... h9h0
        every { reviewedMove2R.movePlayed } returns Move("h9", "h0", BLACK)
        ...
        // 11. e6e5
        every { reviewedMove2R.movePlayed } returns Move("e6", "e5", RED)
        ...
        // 11. ... h0h6
        every { reviewedMove2R.movePlayed } returns Move("h0", "h6", BLACK)
        ...
        // 12. f0e1
        every { reviewedMove2R.movePlayed } returns Move("f0", "e1", RED)
        ...
        // 12. ... h6g6
        every { reviewedMove2R.movePlayed } returns Move("h6", "g6", BLACK)
        ...
        // 13. c2d4
        every { reviewedMove2R.movePlayed } returns Move("c2", "d4", RED)
        ...
        // 13. ... c7e6
        every { reviewedMove2R.movePlayed } returns Move("c7", "e6", BLACK)
        ...
        // 14. e0f0
        every { reviewedMove2R.movePlayed } returns Move("e0", "f0", RED)
        ...
        // 14. ... e7e5
        every { reviewedMove2R.movePlayed } returns Move("e7", "e5", BLACK)
        ...
        // 15. f1f9
        every { reviewedMove2R.movePlayed } returns Move("f1", "f9", RED)
